...
function Seven() {
  ...
  return (
    <div id="contactme" className="parallax-group">
          ...
          >
            ...
            >
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.linkedin.com/in/patrick-liang-42525b14b"
              >
          ...
          >
            ...
            >
              <a
                target="_blank"
                rel="noreferrer"
                href="https://github.com/MrMcPat"
              >
                <FontAwesomeIcon className="contact" icon={faGithub} />
              </a>
            </button>
          </OverlayTrigger>
          <OverlayTrigger
